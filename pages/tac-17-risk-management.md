...
::card{title="Medical Emergency" icon="🏥"}
**Immediate Actions:**
1. Ensure scene safety
2. Provide first aid/CPR
3. Call 911 if needed
4. Contact medical personnel
5. Notify chain of command
6. Document incident

**Key Contacts:**
- Emergency: 911
- Base Medical: [Unit specific]
- Chain of Command: [Unit specific]
::

::card{title="Serious Incident" icon="📞"}
**Immediate Actions:**
1. Ensure safety of all personnel
2. Preserve evidence if applicable
3. Contact chain of command
4. Begin preliminary investigation
5. Document everything
6. Provide support to involved parties
...
::card{title="Weather Emergency" icon="⛈️"}
**Severe Weather Actions:**
1. Monitor weather conditions
2. Implement shelter procedures
3. Suspend outdoor training
4. Account for all personnel
5. Maintain communication
6. Resume operations when safe
...
::card{title="Security Incident" icon="🔒"}
**Security Actions:**
1. Implement security protocols
2. Account for all personnel
3. Secure classified materials
4. Contact security forces
5. Provide situation reports
